        ...
        if response.status_code == 200:
            ...
            for match in data.get('matches', []):
                ...
                if status in ['FINISHED', 'IN_PLAY', 'PAUSED']:
                    # We store the names in clean lowercase keys to guarantee a match
...
# Pull calculated points dictionary (Fully lowercased keys)
...
for player, teams in draft_data.items():
    ...
    for team in teams:
        ...
        # Intercept and redirect to the exact name string generated by the API engine
